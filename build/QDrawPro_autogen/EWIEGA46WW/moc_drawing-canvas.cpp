/****************************************************************************
** Meta object code from reading C++ file 'drawing-canvas.h'
**
...
#error "The header file 'drawing-canvas.h' doesn't include <QObject>."
...
void DrawingCanvas::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (DrawingCanvas::*)(double )>(_a, &DrawingCanvas::zoomChanged, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (DrawingCanvas::*)(const QPointF & )>(_a, &DrawingCanvas::mousePositionChanged, 1))
            return;
    }
}
...
// SIGNAL 0
void DrawingCanvas::zoomChanged(double _t1)
{
    QMetaObject::activate<void>(this, &staticMetaObject, 0, nullptr, _t1);
}

// SIGNAL 1
void DrawingCanvas::mousePositionChanged(const QPointF & _t1)
{
